...
const newsArticles = [
  ...
  },
  {
    ...
    date: "24/04/2025",
    image: "public/lovable-uploads/4776a3a6-a829-4310-bc47-d0ac91a94fbc.png", // Reusing the first image as a placeholder
    ...
    <section id="news" className="section-padding bg-agri-cream-light">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-agri-green-dark mb-8">Tin mới nhất</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {newsArticles.map((article, index) => (
            <div 
              key={index} 
              className="bg-white rounded-lg overflow-hidden shadow-md flex flex-col md:flex-row reveal-animation"
            ...
            >
              ...
              <div className="md:w-3/5 p-6">
                <h3 className="text-lg font-bold text-agri-green-dark mb-2 hover:text-agri-green cursor-pointer">
                  {article.title}
                </h3>
