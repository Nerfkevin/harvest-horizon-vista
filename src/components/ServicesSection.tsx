...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="section-padding bg-agri-cream-light">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-agri-green-dark mb-4">Our Services</h2>
