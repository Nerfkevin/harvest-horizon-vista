      ...
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-agri-earth-light transition-colors">
          ...
          <div className="md:col-span-1">
            <h3 className="text-lg mb-4 text-slate-950 font-bold">Trụ sở Trang Nông</h3>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-agri-earth-light transition-colors">Organic Farming</a></li>
              <li><a href="#" className="hover:text-agri-earth-light transition-colors">Sustainable Forestry</a></li>
              <li><a href="#" className="hover:text-agri-earth-light transition-colors">Solar Integration</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-agri-earth-light transition-colors">Careers</a></li>
              <li><a href="#testimonials" className="hover:text-agri-earth-light transition-colors">Testimonials</a></li>
              <li><a href="#" className="hover:text-agri-earth-light transition-colors">Blog</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-agri-cream-light">
              &copy; {new Date().getFullYear()} GreenHarvest. All rights reserved.
            </p>
            <div className="flex mt-4 md:mt-0 space-x-6">
              <a href="#" className="text-sm text-agri-cream-light hover:text-white transition-colors">Privacy Policy</a>
              <a href="#" className="text-sm text-agri-cream-light hover:text-white transition-colors">Terms of Service</a>
              <a href="#" className="text-sm text-agri-cream-light hover:text-white transition-colors">Sitemap</a>
            </div>
          </div>
        </div>
      </div>
